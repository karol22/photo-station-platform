...
export const CONFIG_KEYS: ConfigKeyDefinition[] = [
  ...
  { key: 'kiosk.captionPhrases', type: 'stringList', group: 'kiosk', name: L('Frases para la foto', 'Photo captions'), description: L('Frases cortas que la persona puede pegar en su foto de un toque. Son texto de negocio y por eso viven aquí y no en la interfaz.', 'Short phrases the customer can stamp on the photo with one tap. They are business text, so they live here and not in the UI.'), default: [], editableAt: all, sensitive: false },
  { key: 'kiosk.captionFont', type: 'string', group: 'kiosk', name: L('Tipografía del texto en la foto', 'Photo caption font'), description: L('Familia tipográfica que la marca ya carga. Vacía deja la del sistema; el código nunca elige una.', 'Font family the brand already loads. Empty leaves the system one; the code never picks one.'), default: '', editableAt: fromOrg, sensitive: false },
  { key: 'kiosk.faceProps.hatAssetId', type: 'asset', group: 'kiosk', name: L('Accesorio: sombrero', 'Prop: hat'), description: L('Dibujo que se coloca solo encima de la cabeza con la malla facial.', 'Artwork placed on top of the head from the face mesh.'), default: null, editableAt: fromOrg, sensitive: false },
  { key: 'kiosk.faceProps.glassesAssetId', type: 'asset', group: 'kiosk', name: L('Accesorio: lentes', 'Prop: glasses'), description: L('Dibujo que se coloca solo sobre la línea de los ojos.', 'Artwork placed on the eye line from the face mesh.'), default: null, editableAt: fromOrg, sensitive: false },
  { key: 'kiosk.faceProps.moustacheAssetId', type: 'asset', group: 'kiosk', name: L('Accesorio: bigote', 'Prop: moustache'), description: L('Dibujo que se coloca solo entre la nariz y el labio.', 'Artwork placed between nose and lip from the face mesh.'), default: null, editableAt: fromOrg, sensitive: false },
  { key: 'kiosk.faceProps.earringAssetId', type: 'asset', group: 'kiosk', name: L('Accesorio: aretes', 'Prop: earrings'), description: L('Dibujo que cuelga de cada oreja; el que queda tapado por el giro de la cabeza no se pega.', 'Artwork hanging from each ear; the one hidden by head turn is not placed.'), default: null, editableAt: fromOrg, sensitive: false },
