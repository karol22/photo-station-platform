...
export const VISION_CAPABILITIES: VisionCapabilityInfo[] = [
  ...
  { key: 'segmentation.person', name: L('Recorte de persona', 'Person segmentation'), purpose: L('Separar a la persona del fondo para reemplazarlo, desenfocarlo o teñirlo.', 'Separate the person from the background to replace, blur or tint it.'), runtimes: ['web', 'android'], cost: 'medium', liveCapable: true, modelMb: 0.24 },
