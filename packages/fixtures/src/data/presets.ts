...
const seeds: PresetSeed[] = [
  {
    ...
    versions: [
      { spec: spec({ widthMm: 35, heightMm: 45, background: 'white', sheetTemplateId: ID.template.sheet4x6, instructions: ['Fondo blanco, rostro serio, orejas visibles.', 'White background, serious face, ears visible.'], defaultCopies: 1, glasses: 'allowed' }), note: 'Versión inicial.', at: '2026-02-01T12:00:00Z' },
      { spec: spec({ widthMm: 35, heightMm: 45, background: 'white', sheetTemplateId: ID.template.sheet4x6, instructions: ['Fondo blanco, rostro serio, orejas visibles, sin lentes oscuros.', 'White background, serious face, ears visible, no tinted glasses.'], defaultCopies: 1, glasses: 'allowed', stabilityMs: 1500 }), note: 'Estabilidad de auto-captura 1500 ms y aclaración sobre lentes.', at: '2026-09-02T12:00:00Z' },
    ],
    searchTerms: ['universidad', 'credencial', 'infantil', '35x45'], tags: ['mx', 'universidad'],
  },
  { id: PS.mxGraduation, name: ['Graduación 50x70 mm', 'Graduation 50x70 mm'], country: 'MX', category: 'graduation', versions: [{ spec: spec({ widthMm: 50, heightMm: 70, background: 'white', sheetTemplateId: ID.template.sheet5x7, instructions: ['Toga o ropa formal; fondo blanco.', 'Gown or formal attire; white background.'], defaultCopies: 1, smile: 'allowed', expression: 'natural', headCover: 'allowed' }), note: 'Versión inicial.', at: '2026-02-01T12:00:00Z' }], searchTerms: ['graduacion', 'diploma', '50x70'], tags: ['mx', 'graduacion'] },
  { id: PS.mxCredential, name: ['Credencial 25x30 mm', 'Credential 25x30 mm'], country: 'MX', category: 'credential', versions: [{ spec: spec({ widthMm: 25, heightMm: 30, background: 'white', sheetTemplateId: ID.template.sheet4x6Credential, instructions: ['Fondo blanco, rostro centrado.', 'White background, centered face.'], defaultCopies: 1 }), note: 'Versión inicial.', at: '2026-02-01T12:00:00Z' }], searchTerms: ['credencial', 'cedula', '25x30'], tags: ['mx', 'co', 'credencial'] },
  { id: PS.mxChild, name: ['Infantil 35x45 mm fondo neutro', 'Child 35x45 mm neutral background'], country: 'MX', category: 'child', versions: [{ spec: spec({ widthMm: 35, heightMm: 45, background: 'neutral', sheetTemplateId: ID.template.sheet4x6, instructions: ['Fondo neutro; el menor mira a la cámara.', 'Neutral background; the child looks at the camera.'], defaultCopies: 1, smile: 'allowed', expression: 'natural', stabilityMs: 900 }), note: 'Versión inicial.', at: '2026-02-01T12:00:00Z' }], searchTerms: ['infantil', 'escuela', '35x45'], tags: ['mx', 'infantil'] },
  { id: PS.usVisa, name: ['Visa EE. UU. 51x51 mm', 'US visa 51x51 mm'], institution: 'Departamento de Estado de EE. UU.', country: 'US', category: 'foreign_visa', versions: [{ spec: spec({ widthMm: 51, heightMm: 51, background: 'white', sheetTemplateId: ID.template.sheet4x6Visa, instructions: ['Fondo blanco, sin lentes, sin sonreír, cabeza descubierta.', 'White background, no glasses, no smile, head uncovered.'], defaultCopies: 1, smile: 'forbidden', glasses: 'forbidden', eyeLine: { min: 0.44, max: 0.52 } }), note: 'Versión inicial.', at: '2026-02-01T12:00:00Z' }], searchTerms: ['visa', 'usa', '2x2', '51x51'], tags: ['us', 'visa'] },
